...
<body onLoad="doOnLoad();">
	...
	<div class="card">
		<div class="card-header text-center bg-primary"><h4>LISTA DADUS KOMPANIA</h4></div>
		<div class="card-body">
			<div class="row">
<div class="col-4">
	...
	<div class="card">
		...
		<div class="card-body">
			<form action="add_kompania.php" method="POST">
			<div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label ">ID KOMPANIA</label>

  <input class="form-control" type="text" name="idkompania" id="idkompania" placeholder="BK0001">

  
</div>
<div class="mb-3">
  <label for="exampleFormControlTextarea1" class="form-label">NARAN KOMPANIA</label>
    <input type="text" name="narankompania" id="narankompania" class="form-control" id="exampleFormControlInput1" placeholder="Input Dadus kompania" style="">

</div>
<div class="mb-3">
  <label for="exampleFormControlTextarea1" class="form-label">ADDRESS KOMPANIA</label>
    <input type="text" name="address" id="address" class="form-control" id="exampleFormControlInput1" placeholder="Input Dadus kompania" style="">

</div>
<div class="mb-3">
  <label for="exampleFormControlTextarea1" class="form-label">OBS</label>
    <input type="text" name="observasaun" id="observasaun"  class="form-control" id="exampleFormControlInput1" placeholder="Input Dadus kompania" style="">
...
<div class="col-8">
	<div class="card">
		<div class="card-header"><h4>LISTA DADUS KOMPANIA </h4></div>
		<div class="card-body">
			<div class="table_tow">
 <table class="table table-hover table-centered mb-0">
     <thead>
         <tr>
             <th>ID KOMPANIA</th>
             <th>NARAN KOMPANIA</th>
             <th>ADDRESS KOMPANIA</th>
             <th>OBS</th>
             <th>ASAUN</th>
     ...
     <tbody>
        ...
        $sql = "SELECT id_kompania, naran_kompania, adress, obs  FROM  kompania";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                echo "<tr>";
                echo "<td>" . $row["id_kompania"] . "</td>";
                echo "<td>" . $row["naran_kompania"] . "</td>"; 
                echo "<td>" . $row["adress"] . "</td>";
                echo "<td>" . $row["obs"] . "</td>";
                echo "<td>";
                echo "<a href='edit.php?id=" . $row["id_kompania"] . "'>Edit</a> | ";
                echo "<a href='hapus_kompania.php?id=" . $row["id_kompania"] . "'>Hapus</a>";
                echo "</td>";
                echo "</tr>";
            }
        } else {
